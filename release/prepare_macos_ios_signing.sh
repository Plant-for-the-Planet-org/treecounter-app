...
gpg --quiet --batch --yes --decrypt --passphrase="$PROVISIONING_PASSWORD" --output release/31f528b5-e436-47ab-b159-9d59e9abb155.mobileprovision release/31f528b5-e436-47ab-b159-9d59e9abb155.mobileprovision.gpg
