...
class SearchProjects extends Component{
    ...
    handleFunction(handleData){
      ...
      if(handleData == 1){
        $("#ProjectSearch").removeClass().addClass('indiviual');
        $("#PriceSearch").removeClass().addClass('many');
        $("#projectSearchTab").show();
      }
      else if(handleData == 2){
        $("#ProjectSearch").removeClass().addClass('many');
        $("#PriceSearch").removeClass().addClass('indiviual');
        $("#projectSearchTab").show();
      }
        ...
        return (
		  ...
		  <h3 className="cs-subHeading">Project Search</h3>		
                    ...
                    <div className="row flex-row f-center">
                        <input type="button" value="Project Search" className="indiviual" onClick={()=>this.handleFunction(1)} id="ProjectSearch"/>
                        <input type="button" value="Price Search" className="many" onClick={()=>this.handleFunction(2)} id="PriceSearch"/>    
                    </div>
                    {this.state.SelectSearchFunction!=-1?
                        <div>
                          <div className="row flex-row f-center" id="projectSearchTab" style={this.props.style}>
