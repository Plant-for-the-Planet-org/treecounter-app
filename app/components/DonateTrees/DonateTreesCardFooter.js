...
const DonateTreesCardFooter = props => {
    ...
    return (
        <div className="card-footer">
            <a  className="leftBtn" href="#">{constants.formStrings.seeMore}</a>
            <Link className="rightBtn" to={route} onClick={e => handleDonateTreesButton(e, value.id)}>{constants.formStrings.donateTrees}</Link>
        </div>
    )
}
