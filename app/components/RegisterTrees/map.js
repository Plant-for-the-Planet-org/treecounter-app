...
export default class Map extends Component {
    ...
    componentWillMount() {
      ...
      const modulesRequired = ["esri/map", "esri/dijit/Search", "esri/dijit/LocateButton", "esri/tasks/locator", "dojo/on", "esri/tasks/AddressCandidate", "esri/geometry/Point", "esri/SpatialReference", "esri/Color", "esri/graphic", "esri/graphicsUtils", "esri/tasks/Geoprocessor", "esri/tasks/FeatureSet", "esri/symbols/SimpleMarkerSymbol", "esri/symbols/SimpleLineSymbol", "esri/symbols/SimpleFillSymbol", "dojo/domReady!", "esri/symbols/PictureMarkerSymbol"];
        esriLoader
          .loadModules(modulesRequired, options)
          .then(
            ([Map,Search,LocateButton,Locator,on,AddressCandidate,Point,SpatialReference,Color,Graphic,graphicsUtils,Geoprocessor,FeatureSet,SimpleMarkerSymbol,SimpleLineSymbol,SimpleFillSymbol,PictureMarkerSymbol]) => {
              ...
              function geocodeSearch(candidate) {
                var resultCoordinates =
                  candidate.results["0"][0].feature.geometry;
              ...
              function Marker() {
                ...
                mapThis.props.pins.forEach((pin) => {
                  let symbol = new esri.symbol.PictureMarkerSymbol(`/client108/assets/icons/${pin.color}.png`,32,32);
    ...
    render() {
      return (
        <div id="mapNode" style={{width: "500px", margin: "auto"}} />
      )
    }
