      ...
      <div className="svg-text-container__row">
        ...
        <div className="svg-text-container__row--col">
          <span>Target by {targetYear} <br />
            ...
            {!targetComment || targetComment === "" ? null : <ArrowButton onToggle={(e) => this.setState({ ifTargetComment: e })} />}
          </span>
        </div>
      </div>
      ...
      <div className="svg-text-container__row">
        ...
        <div className="svg-text-container__row--col">
          <span>Planted
            ...
            <strong>{planted}</strong></span>
        </div>
      </div>
      {this.state.ifPlantedDetails ? <PlantedDetails personal={personal} community={community} /> : null}
    </div>;
  }
}
