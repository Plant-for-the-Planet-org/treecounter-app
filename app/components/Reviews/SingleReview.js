      ...
      >
        ...
        <View style={styles.headerParent}>
          ...
          <View style={{ marginLeft: 10, flexGrow: 1 }}>
            <Text style={styles.reviewUser}>Anthony Cole</Text>
        ...
        <View style={styles.textParent}>
          <Text style={styles.reviewText}>
            ...
            sollicitudin volutpat accumsan. Nulla facilisi. Proin vel purus
            dignissim, sollicitudin nisi quis, gravida enim. Integer convallis
            tincidunt justo, et eleifend mi placerat at. Mauris sodales felis eu
            facilisis congue.
          </Text>
        </View>
