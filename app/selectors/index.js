...
import {
  getRedemptionInfo,
  getValidateInfo
} from '../reducers/redemptionReducer';
...
export const validationCodeSelector = state => getValidateInfo(state);
export const redemptionCodeSelector = state => getRedemptionInfo(state);
