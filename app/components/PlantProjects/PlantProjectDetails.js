 ...
 */
const PlantProjectDetails = ({synopsis1, synopsis2, homepageUrl, homepageCaption, videoUrl, mapData}) => {

  return (<div>
    {(synopsis1 || synopsis2) && <UserSynopsis synopsis1={synopsis1} synopsis2={synopsis2}/>}
    {homepageUrl && <UserHomepageLink homepageUrl={homepageUrl} caption={homepageCaption}/>}
