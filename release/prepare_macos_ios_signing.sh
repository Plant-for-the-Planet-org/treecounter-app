...
gpg --quiet --batch --yes --decrypt --passphrase="$PROVISIONING_PASSWORD" --output release/616ff471-873e-480f-b2c6-a422fc67c2a3.mobileprovision release/616ff471-873e-480f-b2c6-a422fc67c2a3.mobileprovision.gpg
